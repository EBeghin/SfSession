...
$(document).ready(function() { // Une fois que le document (base.html.twig) HTML/CSS a bien été complètement chargé...
    ...
    // fonction permettant l'ajout d'un bouton "Supprimer cette matière" dans un bloc "programme", et d'enregistrer l'évenement "click" associé
    function addDeleteLink($moduleForm) {
        var $removeFormButton = $('<div class="block"><br><button type="button" class="btn btn-primary">Supprimer cette matière</button></div>');
